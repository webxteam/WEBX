...
namespace eosio {
   ...
   class [[eosio::contract("eosio.token")]] token : public contract {
      public:
         ...
         [[eosio::action]]
         void mutetransfer( const name&    from,
                        const name&    to,
                        const asset&   quantity,
                        const string&  memo );              
         /**
         ...
         [[eosio::action]]
         void regminer( const name& miner );
         ...
         using mutetransfer_action = eosio::action_wrapper<"mutetransfer"_n, &token::mutetransfer>;
         using open_action = eosio::action_wrapper<"open"_n, &token::open>;
         using close_action = eosio::action_wrapper<"close"_n, &token::close>;
         using regminer_action = eosio::action_wrapper<"regminer"_n, &token::regminer>;
